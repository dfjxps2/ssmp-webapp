<template>
  <div class="user-list-view" v-if="isAuth">
    <el-header class="filter z-10">
      ...
      <a class="btn btn-user" href="javascript:" @click="handleOper(6, '')" v-if="$store.state.userData.permissionCodes.includes('ucManager')">新建</a>
      <a class="btn btn-user" href="javascript:" @click="handleOper(1, '')" v-if="$store.state.userData.permissionCodes.includes('ucManager')">删除</a>
      <a class="btn btn-user" href="javascript:" @click="handleOper(3, '')" v-if="$store.state.userData.permissionCodes.includes('ucManager')">导出</a>
      <a class="btn btn-user" href="javascript:" @click="handleOper(4, '')" v-if="!$store.state.useBtnFlag">数据同步</a>
      <a class="btn btn-user" href="javascript:" @click="handleOper(5, '')" v-if="$store.state.userData.permissionCodes.includes('ucManager')">下载模板</a>
    </el-header>
    <el-container>
